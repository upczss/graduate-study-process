...
class CaptioningTransformer(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        ############################################################################
        tgt = self.positional_encoding(self.embedding(captions))
    ...
    def sample(self, features, max_length=30):
        ...
        with torch.no_grad():
            ...
            features = torch.as_tensor(features, dtype=self.visual_projection.weight.dtype, device=device)
            N = features.shape[0]
            ...
            partial_caption = torch.as_tensor(partial_caption, dtype=torch.long, device=device)
            # [N] -> [N, 1]
